...
if(bool==false){
    document.getElementById("span").innerHTML="(invalid Number please enter valid number)"
    return false
}
var mail=document.getElementById("six").value
var bool1= /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/.test(mail)
if(bool1==false){
    document.getElementById("mail").innerHTML="(Invalid mail enter correct mail id)"
    return false
}
}